    ...
    <div className="auth-layout">
      <div className="auth-card">
        ...
        <div style={{
          ...
          <strong style={{ color: "var(--green)" }}>Demo:</strong> Dùng bất kỳ email nào trong dữ liệu mẫu,
          mật khẩu: <code style={{ background: "#dcfce7", padding: "1px 5px", borderRadius: 4 }}>greencar123</code>
        </div>
      </div>
    </div>
  );
