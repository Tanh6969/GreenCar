...
type VehicleSpecRepository interface {
	...
	Create(s *entities.VehicleSpec) error
}
...
func (r *vehicleSpecRepository) GetByID(id int) (*entities.VehicleSpec, error) {
...
func (r *vehicleSpecRepository) Create(s *entities.VehicleSpec) error {
