...
type VehicleFeatureRepository interface {
	GetByID(id int) (*domain.VehicleFeature, error)
	Create(f *domain.VehicleFeature) error
}
...
func (r *vehicleFeatureRepository) GetByID(id int) (*domain.VehicleFeature, error) {
...
func (r *vehicleFeatureRepository) Create(f *domain.VehicleFeature) error {
