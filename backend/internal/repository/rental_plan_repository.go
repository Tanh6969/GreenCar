...
type RentalPlanRepository interface {
	GetByID(id int) (*domain.RentalPlan, error)
	Create(p *domain.RentalPlan) error
}
...
func (r *rentalPlanRepository) GetByID(id int) (*domain.RentalPlan, error) {
...
func (r *rentalPlanRepository) Create(p *domain.RentalPlan) error {
