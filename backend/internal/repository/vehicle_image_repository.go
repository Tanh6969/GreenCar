...
type VehicleImageRepository interface {
	GetByID(id int) (*domain.VehicleImage, error)
	Create(img *domain.VehicleImage) error
}
...
func (r *vehicleImageRepository) GetByID(id int) (*domain.VehicleImage, error) {
...
func (r *vehicleImageRepository) Create(img *domain.VehicleImage) error {
